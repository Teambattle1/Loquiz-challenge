...
const dict: Dict = {
    ...
    'hub.share.showtimeLink': { da: 'Direkte Showtime-link', en: 'Direct Showtime link' },
    'hub.share.showtimeTitle': { da: 'Slideshow + podium-reveal', en: 'Slideshow + podium reveal' },
    'hub.share.showtimeExplainer': { da: 'Kunden lander direkte i slideshow af valgte billeder og glider over i podie-reveal når det er færdigt. Vælg billeder i Showtime — valget huskes automatisk.', en: 'Customer lands straight in a slideshow of picked photos and flows into the podium reveal afterwards. Pick photos inside Showtime — the selection is remembered.' },
    'hub.share.photosPicked': { da: 'billeder valgt', en: 'photos picked' },
    'hub.share.photosFallback': { da: 'billeder (alle synlige)', en: 'photos (all visible)' },
